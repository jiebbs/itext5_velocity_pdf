package work.twgj.itext5_velocity_pdf.event;
 ...
 * @date 2022/9/2
 */
public class PdfReportM1HeaderFooterEvent extends PdfPageEventHelper {
     ...
     *
     */
    public PdfReportM1HeaderFooterEvent() {
     ...
     */
    public PdfReportM1HeaderFooterEvent(String header, int presentFontSize, Rectangle pageSize) {
        this.header = header;
